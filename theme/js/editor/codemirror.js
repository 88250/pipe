...
function registerEventHandlers(cm) {
  ...
  on(d.scroller, "mousewheel", function (e) { return onScrollWheel(cm, e); }, {passive: true}); // NOTE: by vanessa
...
ContentEditableInput.prototype.init = function (display) {
  ...
  on(div, "touchstart", function () { return input.forceCompositionEnd(); }, {passive: true}) // Note: by vanessa
