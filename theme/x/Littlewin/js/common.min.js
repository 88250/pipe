...
},{"../../pipe.json":1,"./lib/pjax":3,"jquery":6,"nprogress":7}],3:[function(require,module,exports){
"use strict";
...
var Common = {
  ...
  init: function init() {
    ...
    (0, _common.initPjax)(function () {
      ...
      if ((0, _jquery.default)('#pipeComments').length === 1 && (0, _jquery.default)('#toc').length === 1) {
        (0, _jquery.default)('body').addClass('body--side');
      } else {
        (0, _jquery.default)('body').removeClass('body--side');
      }
    });
    (0, _common.PreviewImg)();
    (0, _common.KillBrowser)();
    (0, _jquery.default)('#sidebarIcon').click(function () {
      Common.toggleSide();
    });
  },
  toggleSide: function toggleSide() {
    ...
    setTimeout(function () {
      (0, _jquery.default)('.header__logo').width((0, _jquery.default)('.header a').get(1).offsetLeft - 30);
    }, 301);
  },
    ...
    for (var i = 0; i < tagsArray.length; i++) {
      ...
      for (var j = 0; j < 5; j++) {
        if (count > j * distance && count <= (j + 1) * distance) {
          tagsArray[i].className = "tag tags__level".concat(j);
          break;
        }
      }
    } // 按字母或者中文拼音进行排序
...
},{"../../../../pipe.json":1,"../../../js/common":2,"./symbol":11,"APlayer":5,"jquery":6}],11:[function(require,module,exports){
"use strict";
