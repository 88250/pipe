...
module.exports={
    ...
    "StaticServer": "http://localhost:5897",
    "StaticResourceVersion": "1512024286464",
    "LogLevel": "debug",
    "SessionSecret": "BEYOND",
    "SessionMaxAge": 86400,
    "RuntimeMode": "dev",
    "DataFilePath": "${home}/pipe.db",
    "PublicPath": "http://localhost:5897/assets/",
    "AxiosBaseURL": "/api",
...
var ParseMarkdown = exports.ParseMarkdown = function ParseMarkdown() {
  ...
  if (hasFlow) {
    ...
    if (typeof flowchart !== 'undefined') {
      ...
      _jquery2.default.ajax({
        method: 'GET',
        url: _pipe2.default.StaticServer + '/theme/js/lib/flowchart.min.js',
        dataType: 'script',
        cache: true
      }).done(function () {
        initFlow();
