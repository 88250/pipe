...
module.exports={
    ...
    "StaticServer": "",
    "StaticResourceVersion": "1512012454645",
    "LogLevel": "debug",
...
var ParseMarkdown = exports.ParseMarkdown = function ParseMarkdown() {
  ...
  if (hasFlow) {
    ...
    if (typeof flowchart !== 'undefined') {
      ...
      _jquery2.default.ajax({
        method: 'GET',
        url: (0, _jquery2.default)('#pipeScript').attr('src').split('theme')[0] + 'theme/js/lib/flowchart.min.js',
        dataType: 'script',
        cache: true
      }).done(function () {
        initFlow();
...
(function () {
  ...
  if ('serviceWorker' in navigator && 'caches' in window && 'fetch' in window) {
    navigator.serviceWorker.register(_pipe2.default.Server + '/sw.js?' + _pipe2.default.StaticResourceVersion, { scope: '/' });
  }
})();

},{"../../pipe.json":1,"jquery":3}],3:[function(require,module,exports){
/*!
...
},{"../../../js/common":2,"./symbol":5,"jquery":3}],5:[function(require,module,exports){
'use strict';
